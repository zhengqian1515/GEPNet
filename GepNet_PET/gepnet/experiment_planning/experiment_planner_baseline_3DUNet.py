...
from gepnet.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from gepnet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from gepnet.experiment_planning.utils import create_lists_from_splitted_dataset
from gepnet.network_architecture.generic_UNet import Generic_UNet
from gepnet.paths import *
from gepnet.preprocessing.cropping import get_case_identifier_from_npz
from gepnet.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnFormerPlans" + "fixed_plans_3D.pkl"
        )
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class(
            [join(gepnet.__path__[0], "preprocessing")],
            self.preprocessor_name,
            current_module="gepnet.preprocessing",
        )
...
if __name__ == "__main__":
    ...
    for t in tasks:
        try:
            ...
            shutil.copy(
                join(nnFormer_raw_data, t, "dataset.json"),
                preprocessing_output_dir_this_task,
            )
