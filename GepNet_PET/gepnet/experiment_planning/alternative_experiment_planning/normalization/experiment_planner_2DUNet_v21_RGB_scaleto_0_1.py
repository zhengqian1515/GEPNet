...
from gepnet.experiment_planning.experiment_planner_baseline_2DUNet_v21 import (
...
class ExperimentPlanner2D_v21_RGB_scaleTo_0_1(ExperimentPlanner2D_v21):
    """
    used by tutorial gepnet.tutorials.custom_preprocessing
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            ...
            "nnFormer_RGB_scaleTo_0_1" + "_plans_2D.pkl",
        )

        # The custom preprocessor class we intend to use is GenericPreprocessor_scale_uint8_to_0_1. It must be located
        # in gepnet.preprocessing (any file and submodule) and will be found by its name. Make sure to always define
        # unique names!
