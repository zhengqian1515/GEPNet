...
from gepnet.experiment_planning.common_utils import get_pool_and_conv_props
from gepnet.experiment_planning.experiment_planner_baseline_3DUNet import (
    ExperimentPlanner,
)
from gepnet.experiment_planning.utils import add_classes_in_slice_info
from gepnet.network_architecture.generic_UNet import Generic_UNet
from gepnet.paths import *
from gepnet.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnFormerPlans" + "_plans_2D.pkl"
        )
    ...
    def plan_experiment(self):
        ...
        print(
            "Are we using the nonzero maks for normalizaion?",
            use_nonzero_mask_for_normalization,
        )
