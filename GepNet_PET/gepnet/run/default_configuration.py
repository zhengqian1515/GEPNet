...
from gepnet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(
    ...
    search_in=(gepnet.__path__[0], "training", "network_training"),
    base_module="gepnet.training.network_training",
):
    assert network in [
        "2d",
        "3d_lowres",
