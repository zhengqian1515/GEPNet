...
import numpy as np
import torch
from gepnet.training.data_augmentation.data_augmentation_moreDA import (
    get_moreDA_augmentation,
)
from gepnet.training.loss_functions.deep_supervision import MultipleOutputLoss2
from gepnet.utilities.to_torch import maybe_to_torch, to_cuda
from gepnet.network_architecture.initialization import InitWeights_He
from gepnet.network_architecture.neural_network import SegmentationNetwork
from gepnet.training.data_augmentation.default_data_augmentation import (
    default_2D_augmentation_params,
    get_patch_size,
    default_3D_augmentation_params,
)
from gepnet.training.dataloading.dataset_loading import unpack_dataset
from gepnet.training.network_training.Trainer_PET import Trainer_PET
from gepnet.utilities.nd_softmax import softmax_helper
from sklearn.model_selection import KFold
from torch import nn
from torch.cuda.amp import autocast
from gepnet.training.learning_rate.poly_lr import poly_lr
from batchgenerators.utilities.file_and_folder_operations import *
# 修改网络
from gepnet.network_architecture.pet.gepnet.models.gepnet import GEPNet

from fvcore.nn import FlopCountAnalysis


class gepnet_trainer_PET(Trainer_PET):
    """
    ...
    def initialize_network(self):
        ...
        self.print_to_log_file(f"Total trainable parameters: {round(n_parameters * 1e-6, 3)} M")
