...
from gepnet.training.dataloading.dataset_loading import (
    load_dataset,
    DataLoader3D,
    DataLoader2D,
    unpack_dataset,
)
from gepnet.training.loss_functions.dice_loss import DC_and_CE_loss
from gepnet.training.network_training.network_trainer_PET import (
    NetworkTrainer_PET,
)
...
class Trainer_PET(NetworkTrainer_PET):
    ...
    def preprocess_patient(self, input_files):
        ...
        assert preprocessor_class is not None, (
            "Could not find preprocessor %s in gepnet.preprocessing"
            % preprocessor_name
        )
    ...
    def validate(
        ...
        if run_postprocessing_on_folds:
            # in the old gepnet we would stop here. Now we add a postprocessing. This postprocessing can remove everything
