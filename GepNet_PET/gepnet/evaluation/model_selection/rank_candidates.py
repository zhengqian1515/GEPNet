...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        "nnFormerTrainerV2_2": [
            "nnFormerPlans",
            "nnFormerPlansisoPatchesInVoxels",
        ],  # r
        "nnFormerTrainerV2": [
            "nnFormerPlansnonCT",
            "nnFormerPlansCT2",
            "nnFormerPlansallConv3x3",
            "nnFormerPlansfixedisoPatchesInVoxels",
            "nnFormerPlanstargetSpacingForAnisoAxis",
            "nnFormerPlanspoolBasedOnSpacing",
            "nnFormerPlansfixedisoPatchesInmm",
            "nnFormerPlansv2.1",
        ],
        "nnFormerTrainerV2_warmup": [
            "nnFormerPlans",
            "nnFormerPlansv2.1",
            "nnFormerPlansv2.1_big",
            "nnFormerPlansv2.1_verybig",
        ],
    ...
    trainers = (
        ["nnFormerTrainer"]
        + ["nnFormerTrainerNewCandidate%d" % i for i in range(1, 28)]
        + [
