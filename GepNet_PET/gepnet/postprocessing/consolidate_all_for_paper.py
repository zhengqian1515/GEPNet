...
def get_commands(
    configurations,
    regular_trainer="nnFormerTrainerV2",
    cascade_trainer="nnFormerTrainerV2CascadeFullRes",
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(
                ...
                trainer,
                plans,
                overwrite_training_output_dir="/datasets/datasets_fabian/results/nnFormer",
            )
