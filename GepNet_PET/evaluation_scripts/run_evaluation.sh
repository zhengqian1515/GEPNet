#!/bin/sh
export PYTHONPATH=/data/MedSegmentation/ZXY/GEPNet-main/GepNet_PET/DATASET
...
LABELS="0 1 2"
python ../gepnet/evaluation/evaluator.py -ref $REF_FOLDER -pred $PRED_FOLDER -l $LABELS
